...
setup_wifi_hotspot() {
  # Assumes you have hostapd and dnsmasq already installed
...
main() {
  local actions=(enable_ssh setup_wifi_hotspot overclock_raspi configure_audio install_vnc_server enable_i2c enable_spi expand_filesystem update_raspi install_docker)
